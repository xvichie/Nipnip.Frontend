    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 pb-24">
        <div className="mb-8 text-center">
          <p className="italic font-serif text-sm text-[#767676] mb-1">{t.grid.collectionEyebrow}</p>
          <h1 className="font-serif text-3xl sm:text-5xl tracking-tight text-[#111111]">{activeCategoryName ?? activeCollectionName ?? t.grid.allProductsTitle}</h1>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="py-32 flex flex-col items-center gap-4 text-center">
            <p className="text-[#767676] text-sm">{t.grid.noProductsFound}</p>
          </div>
        ) : (
          <>
