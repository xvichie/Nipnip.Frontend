      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20">
          ...
          <div className="flex flex-col">
            ...
            {deliveryEstimateText && (
              <p className="text-xs text-white/40 mb-4">{deliveryEstimateText}</p>
            )}

            {tokens.trustBadges.length > 0 && (
              <div className="flex flex-wrap gap-x-4 gap-y-1 mb-8">
                {tokens.trustBadges.map((badge, i) => (
                  <span key={i} className="text-xs font-semibold text-white/40">✓ {getTrustBadgeText(badge, lang)}</span>
                ))}
              </div>
            )}
            ...
            {product.videoUrl && (
              <div className="pt-8 border-t border-white/10">
                <p className="text-xs font-black uppercase tracking-widest text-white/40 mb-3">{t.product.video}</p>
        ...
        {tokens.showRelatedProducts && product.relatedProducts.length > 0 && (
          <div className="mt-16 pt-10 border-t border-white/10">
            <h2 className="font-black text-2xl text-white tracking-tight uppercase mb-6">{relatedProductsHeading || t.product.relatedProducts}</h2>
