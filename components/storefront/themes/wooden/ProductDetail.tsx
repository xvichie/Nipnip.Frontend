      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 pb-16">
          ...
          <div className="flex flex-col">
            ...
            {product.description && (
              <div className="pt-6 border-t border-[#e8ddd0]">
                <p className="text-xs font-semibold uppercase tracking-widest text-[#c4b7a6] mb-3">აღწერა</p>
            ...
            {product.videoUrl && (
              <div className="pt-6 border-t border-[#e8ddd0]">
                <p className="text-xs font-semibold uppercase tracking-widest text-[#c4b7a6] mb-3">ვიდეო</p>
        ...
        {tokens.showRelatedProducts && product.relatedProducts.length > 0 && (
          <div className="mt-14 pt-8 border-t border-[#e8ddd0]">
            <h2 className="font-bold text-2xl text-[#4a3f35] mb-6">{tokens.relatedProductsHeading || 'მსგავსი პროდუქტები'}</h2>
