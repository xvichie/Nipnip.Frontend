          ...
          <div className={`flex flex-wrap items-center gap-3 ${getHeroButtonRowClass(cfg)}`}>
            {cfg.heroCtaEnabled && (
              <Link
                ...
                className="inline-flex items-center gap-2 text-sm font-black uppercase tracking-wide px-7 py-3 theme-cta-btn"
            ...
            {cfg.heroSecondaryCtaEnabled && (
              <Link
                ...
                className="inline-flex items-center gap-2 border-2 text-sm font-black uppercase tracking-wide px-7 py-3 theme-cta-btn"
