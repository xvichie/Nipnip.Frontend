      ...
      >
        <div className="relative aspect-square bg-[#eaf7fc] overflow-hidden">
          ...
          {product.thumbnailUrl ? (
            ...
            <div className="w-full h-full flex items-center justify-center text-[#b8d8e6] text-xs font-medium">სურათი არ არის</div>
          )}
          <QuickAddButton
            slug={slug}
        ...
        <div className="p-4 flex flex-col flex-1">
          ...
          <h3 className="text-[#2b2b2b] font-bold text-sm leading-snug mb-2">{product.name}</h3>
