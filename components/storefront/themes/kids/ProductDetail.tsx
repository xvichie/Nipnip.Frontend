      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-16">
          ...
          <div className="flex flex-col">
            ...
            {tokens.deliveryEstimateText && (
              <p className="text-xs font-medium text-[#9a9a9a] mb-4">{tokens.deliveryEstimateText}</p>
            )}

            {tokens.trustBadges.length > 0 && (
              <div className="flex flex-wrap gap-x-4 gap-y-1 mb-8">
                {tokens.trustBadges.map((badge, i) => (
                  <span key={i} className="text-xs font-medium text-[#9a9a9a]">✓ {badge}</span>
                ))}
              </div>
            )}
        ...
        {tokens.showRelatedProducts && product.relatedProducts.length > 0 && (
          <div className="mt-16 pt-10 border-t border-[#ffe9d2]">
            <h2 className="font-black text-2xl text-[#2b2b2b] tracking-tight mb-6">{tokens.relatedProductsHeading || t.product.relatedProducts}</h2>
