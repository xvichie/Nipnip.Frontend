      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 pb-20">
          ...
          <div className="flex gap-3">
            ...
            >
              {images[activeImage] ? (
                ...
                <div className="w-full h-full flex items-center justify-center text-[#b8b8b8] text-xs font-medium">სურათი არ არის</div>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            {product.description && (
              <div className="pt-8 border-t border-[#ffe9d2]">
                <p className="text-xs font-bold uppercase tracking-widest text-[#b8b8b8] mb-3">აღწერა</p>
            ...
            {product.videoUrl && (
              <div className="pt-8 border-t border-[#ffe9d2]">
                <p className="text-xs font-bold uppercase tracking-widest text-[#b8b8b8] mb-3">ვიდეო</p>
        ...
        {tokens.showRelatedProducts && product.relatedProducts.length > 0 && (
          <div className="mt-16 pt-10 border-t border-[#ffe9d2]">
            <h2 className="font-black text-2xl text-[#2b2b2b] tracking-tight mb-6">{tokens.relatedProductsHeading || 'მსგავსი პროდუქტები'}</h2>
