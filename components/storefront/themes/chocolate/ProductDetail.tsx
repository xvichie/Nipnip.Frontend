      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 pb-20">
          ...
          <div className="flex flex-col">
            ...
            {product.description && (
              <div className="pt-7 border-t border-[#3b2418]/10">
                <p className="text-xs uppercase tracking-widest text-[#a68a6d] mb-3">აღწერა</p>
            ...
            {product.videoUrl && (
              <div className="pt-7 border-t border-[#3b2418]/10">
                <p className="text-xs uppercase tracking-widest text-[#a68a6d] mb-3">ვიდეო</p>
        ...
        {tokens.showRelatedProducts && product.relatedProducts.length > 0 && (
          <div className="mt-16 pt-10 border-t border-[#3b2418]/10">
            <p className="text-xs uppercase tracking-widest text-[#a68a6d] mb-6">{tokens.relatedProductsHeading || 'მსგავსი პროდუქტები'}</p>
