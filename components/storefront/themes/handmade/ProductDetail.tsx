      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 pb-16">
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1 aspect-[4/5] bg-[#e8ddd0] overflow-hidden">
              {images[activeImage] ? (
                ...
                <div className="w-full h-full flex items-center justify-center text-[#8f8274] text-xs">სურათი არ არის</div>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            {product.description && (
              <div className="pt-6 border-t border-[#2b2420]/10">
                <p className="italic font-serif text-sm text-[#8f8274] mb-3">აღწერა</p>
                <p className="font-serif text-base leading-relaxed max-w-md text-[#2b2420]">{product.description}</p>
              </div>
            )}

            {product.videoUrl && (
              <div className="pt-6 border-t border-[#2b2420]/10">
                <p className="italic font-serif text-sm text-[#8f8274] mb-3">ვიდეო</p>
        ...
        {tokens.showRelatedProducts && product.relatedProducts.length > 0 && (
          <div className="mt-16 pt-10 border-t border-[#2b2420]/10">
            <p className="italic font-serif text-sm text-[#8f8274] mb-6">{tokens.relatedProductsHeading || 'მსგავსი პროდუქტები'}</p>
