  ...
  return (
    <div className={`${surface.page} min-h-screen`}>
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-16 pb-24">
        <h1 className={`font-black text-3xl sm:text-4xl tracking-tight mb-8 ${surface.text}`}>{getPageTitle(page, lang)}</h1>
        <p className={`text-sm leading-relaxed whitespace-pre-wrap ${surface.text}`}>{getPageContent(page, lang)}</p>
