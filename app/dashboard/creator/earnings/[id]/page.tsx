...
export default function EarningDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="rounded-2xl border border-white/7 bg-white/2 overflow-hidden">
            ...
            {[
              { label: t.detail.merchant,     value: `${data.merchantName} (/${data.merchantSlug})` },
