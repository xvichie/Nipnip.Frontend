        ...
        <div className="flex flex-col gap-2">
          ...
          {order.discountAmount > 0 && (
            <div className="flex items-center gap-3 rounded-xl bg-emerald-500/5 border border-emerald-500/15 px-4 py-2.5">
              <div className="min-w-0 flex-1">
                <p className="text-sm text-emerald-400">ფასდაკლება{order.discountCode ? ` — ${order.discountCode}` : ''}</p>
              </div>
              <p className="text-emerald-400 text-sm font-medium shrink-0">−{order.discountAmount.toFixed(2)} ₾</p>
            </div>
          )}
        </div>
