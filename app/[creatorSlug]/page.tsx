...
import type { LinkTreeResponse } from '@/lib/types'

async function getLinkTree(slug: string): Promise<LinkTreeResponse | null> {
  try {
    return await apiFetch<LinkTreeResponse>(`/api/creators/${slug}/linktree`, null)
  } catch (err) {
